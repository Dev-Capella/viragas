                ...
                {data !== null &&
                    data.map((item, i) => (
                        <div key={i} className="bg-white">
                            ...
                            <button onClick={()=> navigate(item.slug)} className="mt-3 bg-yellow-500 hover:bg-gray-700 duration-300 delay-100 py-4 px-6 text-black anton-regular  hover:text-white">
                                Devamını Oku
                            </button>
                        </div>
                    ))}
