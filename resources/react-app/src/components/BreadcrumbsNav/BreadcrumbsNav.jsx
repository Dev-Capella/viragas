...
const BreadcrumbsNav = ({ imageSrc, text,title }) => {
    return (
        <div className="relative flex justify-center items-center">
            ...
            <p class="absolute w-full text-white text-[14rem]  max-2xl:text-[10rem] max-xl:text-[8rem] max-lg:text-[6rem] max-md:text-[2rem] font-bold opacity-10 text-center">VİRA GAS</p>
