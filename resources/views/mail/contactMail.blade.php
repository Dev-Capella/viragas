      ...
      <tr>
        <td valign="top">
          <table cellpadding="0" cellspacing="0" class="es-header" align="center">
            <tr>
              <td align="center">
                <table bgcolor="#ffffff" class="es-header-body" align="center" cellpadding="0" cellspacing="0" width="600" style="border-radius: 20px 20px 0px 0px;background-image: url(https://qbcgtf.stripocdn.email/content/guids/CABINET_22fda5291d5015a70dd4bd9ba20196304aa67b494a1d67c9ea36ef7797d39dde/images/rectangle_243.png);background-repeat: no-repeat;background-position: left top">
                  <tr>
                    <td class="es-p30t es-p15b es-p40r es-p40l es-m-p20r es-m-p20l" align="left">
                      <table cellpadding="0" cellspacing="0" width="100%">
                        <tr>
                          <td width="520" class="es-m-p0r" valign="top" align="center">
                            <table cellpadding="0" cellspacing="0" width="100%">
                              <tr>
            ...
            <tr>
              <td align="center">
                <table class="es-content-body" width="600" cellspacing="0" cellpadding="0" bgcolor="#edf2fb" align="center">
                  <tr>
                    <td class="es-p30t es-p20b es-p40r es-p40l es-m-p20r es-m-p20l" align="left">
                        ...
                        <tr>
                          <td class="es-m-p0r es-m-p20b" width="560" valign="top" align="center">
                            <table width="100%" cellspacing="0" cellpadding="0" style="border-radius: 10px;border-collapse: separate;background-color: #ffffff" bgcolor="#ffffff">
                              <tr>
                                <td align="center" class="es-p30"><h1 style="line-height: 150%">İletişim Formu</h1></td>
                              </tr>
                              <tr>
                                <td align="left" class="es-p30b es-p30r es-p30l">
                  ...
                  <tr>
                    <td class="es-p40b es-p40r es-p40l es-m-p20r es-m-p20l" align="left">
                      <table cellpadding="0" cellspacing="0" width="100%">
                        <tr>
          ...
          <!-- Add other sections of your email template here -->
        </td>
      </tr>
    </table>
  </div>
